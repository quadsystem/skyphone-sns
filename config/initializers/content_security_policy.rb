...
Rails.application.config.content_security_policy do |p|
  ...
  if Rails.env.development?
    ...
    p.connect_src :self, :data, :blob, assets_host, media_host, Rails.configuration.x.streaming_api_base_url, "https://*.google-analytics.com", "https://*.analytics.google.com", "https://*.googletagmanager.com", "https://unpkg.com", "https://*.skyphone.jp", "https://*.firebaseio.com", "wss://*.firebaseio.com", "https://*.firebasedatabase.app/", "wss://*.firebasedatabase.app", Rails.configuration.x.upload_base_url
