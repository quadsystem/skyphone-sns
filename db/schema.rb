...
ActiveRecord::Schema.define(version: 2022_10_28_013526) do
  ...
  create_table "payment_apple_purchase_transactions", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["notification_uuid"], name: "index_payment_apple_purchase_transactions_on_notification_uuid", unique: true
  end

  create_table "payment_google_purchase_transactions", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["message_id"], name: "index_payment_google_purchase_transactions_on_message_id", unique: true
  end

  create_table "payment_purchase_transactions", force: :cascade do |t|
    t.bigint "account_id"
    t.string "service"
    t.string "product"
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["account_id"], name: "payment_purchase_transactions_index"
    t.index ["service", "transaction_id"], name: "payment_purchase_transactions_service_index", unique: true
  end
