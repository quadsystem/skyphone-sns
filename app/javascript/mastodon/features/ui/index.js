...
import AdContainer from './containers/ad_container';
    ...
    return (
      <ColumnsAreaContainer ref={this.setRef} singleColumn={mobile}>
        <WrappedSwitch>
          ...
          {/* SkyPhoneSNS original start */}
          <WrappedRoute path='/about-ad' component={AdAbout} content={children} />
          {/* SkyPhoneSNS original end */}
